...
const msgtxt5 = '<p class="image"><img src ="img/penguins.jpg" width=61px height=61px></p><img src="img/whitebear.jpg" width=61px height=61px></p><p class = "text animate__bounceIn">Draw!!</p>';
